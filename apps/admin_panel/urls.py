...
urlpatterns = [
    ...
    path('students/reset-password-api/', views.reset_student_password_api_view, name='reset_student_password_api'),
    path('tokens/<int:token_id>/report-api/', views.token_report_api_view, name='token_report_api'),
    path('tokens/<int:token_id>/export/', views.export_token_excel_view, name='export_token_excel'),
    path('tokens/<int:token_id>/delete/', views.token_delete_view, name='token_delete'),
    ...
    path('tka/export/', views.export_tka_excel_view, name='export_tka_excel'),
    path('literasi/', views.literasi_list_view, name='literasi_list'),
    path('literasi/grade-api/', views.grade_literasi_api_view, name='grade_literasi_api'),
    path('literasi/export/', views.export_literasi_excel_view, name='export_literasi_excel'),
